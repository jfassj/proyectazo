...
function AlumnoModificare() {
  ...
  const handleSubmite = (event) => {
    ...
    modifyAlumnoe(alumno);
  };

  const modifyAlumnoe = async (data) => {
    const response = await axios.post(
      "http://localhost:5000/estadias/modificar",
      data
    );
    if (response.status === 200) {
    ...
    const showToastMessage = () => {
        toast.warning('A modificado un valor !', {
  ...
  return (
    <>
      <Container>
        <Row>
          <Col>
            <h1>Modificar Memoria de estadia</h1>
          </Col>
        </Row>
        ...
        <Form onSubmit={handleSubmite}>
          ...
          <Row className="mt-3 mb-3">
            <Col>
              <p className="fs-3">Datos Generales del parte de personal administrativo</p>
            </Col>
          </Row>
          <Row className="mt-3 mb-3">
            <Col>
          ...
          <Row>
            <Col>
              <Button type="submit" className="btn btn-primary" onClick={showToastMessage}>
                Guardar
                <ToastContainer />
              </Button>
            </Col>
...
export default AlumnoModificare;
