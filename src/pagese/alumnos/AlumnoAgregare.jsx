...
function AlumnoAgregare() {
  ...
  const addAlumnoe = async (data) => {
    const response = await axios.post(
      "http://localhost:5000/estadias/agregar",
      data
    );
  ...
  const showToastMessage = () => {
    toast.success("A agregado un Registro !", {
  ...
  return (
    <>
      <Container>
        <Row>
          <Col>
            <h1>Agregar Memoria de Estadia</h1>
          </Col>
        </Row>
